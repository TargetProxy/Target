...
#include <targetlib/targetlib_plugin.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) targetlib_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "TargetlibPlugin");
  targetlib_plugin_register_with_registrar(targetlib_registrar);
